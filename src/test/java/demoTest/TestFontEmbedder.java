...
public class TestFontEmbedder {

    private String fontDirectory;

    public TestFontEmbedder() {
    ...
    public void renderPdfWithoutFontEmbeddig() throws Exception {
        FontEmbedder embedder = new FontEmbedder("TestFontEmbedder_PdfWithoutFontEmbeddig", fontDirectory);
    ...
    public void renderPdfWithFontEmbeddig() throws Exception {
        FontEmbedder embedder = new FontEmbedder("TestFontEmbedder_PdfWithFontEmbeddig", fontDirectory);
