...
public class SaverSubImageRotated {
     ...
     */
    public SaverSubImageRotated(String fileName, int dpi, int pageSizePt, int left, int bottom, int top, int right) {
        try {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SaverSubImageRotated draw = new SaverSubImageRotated(fileName, pageDPI, Math.round(PageSize.A4.getHeight()), 36, 36, 559, 806);
