...
public class ElementFactoryEx {
    ...
    public static Chunk getChunk(Properties attributes) {
        ...
        value = attributes.getProperty(CSS_KEY_VERTICALALIGN);
        ...
        if (value != null) {
            chunk.setBackground(decodeColor(value));
        }
        return chunk;
    }
    ...
    public static Phrase getPhrase(Properties attributes) {
        ...
        value = attributes.getProperty(CSS_KEY_LINEHEIGHT);
        if (value != null) {
            phrase.setLeading(parseLength(value,
                    DEFAULT_FONT_SIZE));
        }
        value = attributes.getProperty(ElementTags.ITEXT);
        if (value != null) {
    ...
    private static void setRectangleProperties(Rectangle rect,
        ...
        if (r != null || g != null || b != null) {
            ...
            rect.setBorderColor(decodeColor(attributes
        ...
        if (r != null || g != null || b != null) {
            ...
            rect.setBackgroundColor(decodeColor(value));
        } else {
