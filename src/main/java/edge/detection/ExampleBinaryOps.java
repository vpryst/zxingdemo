...
*/
/**
 * * Demonstrates how to create binary images by thresholding, applying binary morphological operations, and * then extracting detected
 * features by finding their contours. * * @author Peter Abeles
 */
public class ExampleBinaryOps {
 /*   public static void main(String args[]) {
        ...
        BufferedImage visualContour =
            VisualizeBinaryData.renderContours(contours, colorExternal, colorInternal, input.width, input.height, null);
