...
/**
 * * Demonstration of the Canny edge detection algorithm. In this implementation the output can be a binary image and/or * a graph
 * describing each contour. * * @author Peter Abeles
 */
