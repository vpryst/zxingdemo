...
/**
 * * Example of how to find objects inside an image using template matching. Template matching works * well when there is little noise in
 * the image and the object's appearance is known and static. * * @author Peter Abeles
 */
public class Example {
    /**
     * * Demonstrates how to search for matches of a template inside an image * * @param image Image being searched * @param template
     * Template being looked for * @param expectedMatches Number of expected matches it hopes to find * @return List of match location and
     * scores
     */
    ...
    public static void main(String args[]) {
        ...
        String directory = "img/scaned_files/Temp/";
        ImageFloat32 image = UtilImageIO.loadImage(directory + "SK.jpg", ImageFloat32.class);
        ImageFloat32 templateX = UtilImageIO.loadImage(directory + "rectangle.jpg", ImageFloat32.class);
...
//        drawRectangles(g2, image, templateBrowser, 1);
    ...
    private static void drawRectangles(Graphics2D g2, ImageFloat32 image, ImageFloat32 template, int expectedMatches) {
