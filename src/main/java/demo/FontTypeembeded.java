...
public class FontTypeembeded {
    ...
    public static class MyFontFactory implements FontProvider {
        public Font getFont(String fontname, String encoding, boolean embedded, float size, int style, Color color) {
            ...
            FontFactory.getFont(BaseFont.HELVETICA, BaseFont.CP1252, BaseFont.EMBEDDED);
            System.out.println(fontname + " " + size);
            
            return FontFactory.getFont(BaseFont.HELVETICA);
        }
...
//            
//            str += "<span style=\"font-size: 10;font-family: Arial;\">&nbsp;None of the above<br>.Do you really think it is a valid sequence?<br>I don't think so.</span>"
...
//                + "<span style=\"font-size: 10;font-family: Arial;\">&nbsp;63</span>";
            ...
            //styles.loadTagStyle("span", "font-family", BaseFont.COURIER);
//            BaseFont cfont = BaseFont.createFont(BaseFont.HELVETICA, BaseFont.WINANSI, true);
//            
            HashMap<String,Object> providers = new HashMap<String, Object>();
//            providers.put("font_factory", new DefaultFontProvider(BaseFont.HELVETICA));
            providers.put("font_factory", new MyFontFactory());
       
            
            
            
            ArrayList list = htmlWorker.parseToList(new StringReader(str), null, providers);
            for (Object line : list) {
                document.add((Element) line);
            }
            document.add(new Paragraph("sdgfssdfgd", FontFactory.getFont(BaseFont.HELVETICA)));
//            
